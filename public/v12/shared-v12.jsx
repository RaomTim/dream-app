...
const GeoSymbol = ({ kind, color = "silk", style = {}, opacity }) => {
  // Aliases tolérés (compat V1.2 amplifiée)
...
const ConstellationD3 = ({
  ...
  uV12E(() => {
    ...
    let raf = 0;
    let last = 0;
    // Clamp nodes inside viewport (prevent labels from clipping at edges)
    // 2026-04-25 — fix overflow visible dans Portrait/Cercle/Anima
    const clampPad = 40; // px padding for label width
    const clampNodes = () => {
...
// ══════════════════════════════════════════════════════════════
//
// Wow 0 : "first-launch"               — premier accès Onboarding (P-Zéro)
...
// ══════════════════════════════════════════════════════════════
// 8. isPostJ30 — helper J0-J30 gradient (B+D refonte 2026-04-26)
//    Spec : Design §11.bis.6 (somatic gate opt-in J30) + §11.bis.7 (felt-shift 6-zones J30).
//    Lit un flag de date depuis localStorage et retourne true si > N jours.
// ══════════════════════════════════════════════════════════════
