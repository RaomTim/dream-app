...
const KairosDetail = ({ go, entry, allEntries }) => {
  ...
  const [feltShift, setFeltShift] = useS2(null); // null | 'frisson' | 'relache' | 'rien' | 'pas-maintenant'
  const [showAha, setShowAha] = useS2(false);
  ...
  return (
    <div className="stage screen-enter" style={{ background: "var(--night-warm)" }}>
      ...
      <div className="frame" style={{ position: "relative" }}>
        ...
        {showAha && (
          <window.AhaCapture context="kairos-detail" onClose={() => setShowAha(false)} />
        )}
